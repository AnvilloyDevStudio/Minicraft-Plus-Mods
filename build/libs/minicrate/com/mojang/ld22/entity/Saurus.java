...
public class Saurus extends Mob
{
    private int xa;
    private int ya;
    private int lvl;
    ...
    public void render(final Screen screen) {
        ...
        int col = Color.get(-1, 333, 222, 111);
        if (this.lvl == 2) {
            col = Color.get(-1, 333, 222, 111);
        }
        if (this.lvl == 3) {
            col = Color.get(-1, 333, 222, 111);
        }
    ...
    protected void die() {
        super.die();
        for (int count = this.random.nextInt(20) + 1, i = 0; i < count; ++i) {
