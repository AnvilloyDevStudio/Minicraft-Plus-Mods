...
public class FreshWaterTile extends Tile
{
    private Random wRandom;
    
    public FreshWaterTile(final int id) {
        super(id);
    ...
    public void render(final Screen screen, final Level level, final int x, final int y) {
        this.wRandom.setSeed((FreshWaterTile.tickCount + (x / 2 - y) * 4311) / 10 * 54687121L + x * 3271612L + y * 3412987161L);
        final int col = Color.get(115, 115, 225, 225);
