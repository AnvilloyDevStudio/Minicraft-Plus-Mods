...
public class MonkeyBoy extends Mob
{
    private int xa;
    private int ya;
    private int lvl;
    ...
    public MonkeyBoy(final int lvl) {
    ...
    protected void touchedBy(final Entity entity) {
        if (entity instanceof Player) {
            ...
            if (MonkeyBoy.playerShape == 5) {
                MonkeyBoy.playerShape = 2;
            }
            else {
                MonkeyBoy.playerShape = 5;
            }
        }
    }
    ...
    protected void die() {
        super.die();
        for (int count = this.random.nextInt(5) + 1, i = 0; i < count; ++i) {
        ...
        if (this.random.nextInt(3) == 0) {
            this.level.add(new ItemEntity(new ResourceItem(Resource.mango), this.x + this.random.nextInt(11) - 5, this.y + this.random.nextInt(11) - 5));
        }
