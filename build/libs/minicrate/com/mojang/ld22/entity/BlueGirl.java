...
import com.mojang.ld22.menu.conversation.BlueGirlsMenu;
import com.mojang.ld22.gfx.Color;
import com.mojang.ld22.gfx.Screen;

public class BlueGirl extends Mob
{
    private int xa;
    private int ya;
    private int lvl;
    ...
    public boolean use(final Player player, final int attackDir) {
        player.game.setMenu(new BlueGirlsMenu(null));
        return true;
    }
    ...
    protected void die() {
        ...
        if (this.random.nextInt(3) == 0) {
            this.level.add(new ItemEntity(new ResourceItem(Resource.cherryPie), this.x + this.random.nextInt(11) - 5, this.y + this.random.nextInt(11) - 5));
        }
