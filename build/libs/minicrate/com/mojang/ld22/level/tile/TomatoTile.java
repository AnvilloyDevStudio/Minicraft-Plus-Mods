...
public class TomatoTile extends Tile
{
    public int isWand;
    public int isStaff;
    
    public TomatoTile(final int id) {
        super(id);
    ...
    public void tick(final Level level, final int xt, final int yt) {
        if (this.random.nextInt(400) == 0) {
            level.add(new ItemEntity(new ResourceItem(Resource.tomato), xt * 16 + this.random.nextInt(6) + 5, yt * 16 + this.random.nextInt(6) + 5));
        }
        ...
        if (level.getTile(xn, yn) == Tile.dirt) {
            level.setTile(xn, yn, TomatoTile.tomato, 0);
        ...
        if (this.isWand == 0) {
            ...
            if (damage >= 5) {
                for (int count = this.random.nextInt(2) + 1, i = 0; i < count; ++i) {
                    level.add(new ItemEntity(new ResourceItem(Resource.tomatoSeeds), x * 16 + this.random.nextInt(10) + 3, y * 16 + this.random.nextInt(10) + 3));
                }
                for (int count = this.random.nextInt(3) + 1, i = 0; i < count; ++i) {
                    level.add(new ItemEntity(new ResourceItem(Resource.potato), x * 16 + this.random.nextInt(10) + 3, y * 16 + this.random.nextInt(10) + 3));
                }
