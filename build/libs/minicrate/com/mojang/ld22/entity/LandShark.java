...
public class LandShark extends Mob
{
    private int xa;
    private int ya;
    private int lvl;
    ...
    public void render(final Screen screen) {
        ...
        int col = Color.get(-1, 1, 555, 222);
        if (this.lvl == 2) {
            col = Color.get(-1, 1, 555, 222);
        }
        if (this.lvl == 3) {
            col = Color.get(-1, 1, 555, 222);
        }
    ...
    protected void touchedBy(final Entity entity) {
        if (entity instanceof Player) {
            ...
            entity.hurt(this, 10, this.dir);
        }
        else if (entity instanceof GirlZombie) {
            entity.hurt(this, 10, this.dir);
        }
        else if (entity instanceof MonkeyBoy) {
            entity.hurt(this, 10, this.dir);
        }
        else if (entity instanceof Turducken) {
            entity.hurt(this, 10, this.dir);
        }
    }
