...
public class BatZap extends Entity
{
    ...
    public double yy;
    private int time;
    private HellBat owner;
    int rotation;
    int spin;
    
    public BatZap(final HellBat owner, final double xa, final double ya) {
        this.rotation = 0;
        this.spin = 0;
        this.owner = owner;
        final int x = owner.x;
    ...
    public void tick() {
        ...
        for (int i = 0; i < toHit.size(); ++i) {
            ...
            if (e instanceof Mob && !(e instanceof HellBat)) {
