...
public class TileItem extends StackableItem {
	...
	public TileItem(String name, Sprite sprite, int count, String model, String... validTiles) {
		this(name, sprite, count, model, Arrays.asList(validTiles));
	}
	public TileItem(String name, Sprite sprite, int count, String model, List<String> validTiles) {
