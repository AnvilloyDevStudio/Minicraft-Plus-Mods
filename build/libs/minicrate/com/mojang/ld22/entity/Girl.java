...
import com.mojang.ld22.menu.conversation.BuyingMenu;
...
public class Girl extends Mob
{
    ...
    public void render(final Screen screen) {
        ...
        int col = Color.get(-1, 500, 511, 544);
        if (this.hurtTime > 0) {
    ...
    public boolean use(final Player player, final int attackDir) {
        player.game.setMenu(new BuyingMenu(Crafting.girlSales, player));
        return true;
    }
