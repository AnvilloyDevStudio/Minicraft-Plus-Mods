...
public class IColor {
    public static final int TRANSPARENT = IColor.get(0, 0);
	public static final int WHITE = IColor.get(1, 255);
	public static final int GRAY = IColor.get(1, 153);
	public static final int DARK_GRAY = IColor.get(1, 51);
	public static final int BLACK = IColor.get(1, 0);
	public static final int RED = IColor.get(1, 255, 0, 0);
	public static final int GREEN = IColor.get(1, 0, 255, 0);
	public static final int BLUE = IColor.get(1, 0, 0, 255);
	public static final int YELLOW = IColor.get(1, 255, 255, 0);
	public static final int MAGENTA = IColor.get(1, 255, 0, 255);
	public static final int CYAN = IColor.get(1, 0, 255, 255);

	public static final char COLOR_CHAR = '\u00A7';

	public static final String TRANSPARENT_CODE = IColor.toStringCode(IColor.TRANSPARENT);
	public static final String WHITE_CODE = IColor.toStringCode(IColor.WHITE);
	public static final String GRAY_CODE = IColor.toStringCode(IColor.GRAY);
	public static final String DARK_GRAY_CODE = IColor.toStringCode(IColor.DARK_GRAY);
	public static final String BLACK_CODE = IColor.toStringCode(IColor.BLACK);
	public static final String RED_CODE = IColor.toStringCode(IColor.RED);
	public static final String GREEN_CODE = IColor.toStringCode(IColor.GREEN);
	public static final String BLUE_CODE = IColor.toStringCode(IColor.BLUE);
	public static final String YELLOW_CODE = IColor.toStringCode(IColor.YELLOW);
	public static final String MAGENTA_CODE = IColor.toStringCode(IColor.MAGENTA);
	public static final String CYAN_CODE = IColor.toStringCode(IColor.CYAN);
	...
	public static int get(String color) {
		...
		return IColor.get(color.charAt(leading), color.charAt(1 + leading), color.charAt(2 + leading), color.charAt(3 + leading));
	}
	...
	public static String toString(int col) {
		return java.util.Arrays.toString(IColor.separateEncodedSprite(col, true));
	}
}
