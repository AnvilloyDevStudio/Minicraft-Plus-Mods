...
public class RockTile extends Tile
{
    ...
    public void render(final Screen screen, final Level level, final int x, final int y) {
        ...
        final int transitionColor = Color.get(111, 444, 555, level.dirtColor);
    ...
    public void hurt(final Level level, final int x, final int y, final int dmg) {
        ...
        if (damage >= 40) {
            ...
            count = this.random.nextInt(6) + 1;
            if (count == 4) {
                level.add(new ItemEntity(new ResourceItem(Resource.silverOre), x * 16 + this.random.nextInt(10) + 3, y * 16 + this.random.nextInt(10) + 3));
            }
